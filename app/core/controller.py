...
class AppController:
    ...
    def scan_groups(self, d=10): self.session_controller.scan_groups(d)
    def host_group(self, r=False): self.session_controller.host_group(r)
    ...
    async def _recover_agent(self): await self.recovery_controller.recover_agent()
    ...
    def _on_p2p_done(self, u): self.transfer_controller.on_p2p_done(u)
    ...
    async def _execute_p2p_send(self, ip: str, port: int, pending: dict): await self.transfer_controller.execute_p2p_send(ip, port, pending)
